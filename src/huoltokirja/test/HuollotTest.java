 ...
 * @version 2021.04.18 21:21:42 // Generated by ComTest
 *
 */
...
public class HuollotTest {
  ...
  /** testAnnaHinnat300 */
  @Test
  public void testAnnaHinnat300() {    // Huollot: 300
    Huollot huollot = new Huollot(); 
    ...
    assertEquals("From: Huollot line: 312", 200, hinnat[0], 0.000001); 
    assertEquals("From: Huollot line: 313", 300, hinnat[5], 0.000001); 
    assertEquals("From: Huollot line: 314", 0, hinnat[11], 0.000001); 
    hinnat = huollot.annaHinnat(2019); 
    assertEquals("From: Huollot line: 316", 400, hinnat[11], 0.000001); 
  } // Generated by ComTest END
   ...
   */
  @Test
  public void testAnnaVuodet343() throws IndexOutOfBoundsException {    // Huollot: 343
    Huollot huollot = new Huollot(); 
    Huolto huolto = new Huolto(); 
    huolto.parse(" 2  |  2  | 1.1.2020|200  | Iskari  | 100 | Öljynvaihto"); 
    huollot.lisaa(huolto); 
    assertEquals("From: Huollot line: 349", "2020", huollot.annaVuodet().get(0)); 
    try {
    assertEquals("From: Huollot line: 350", "", huollot.annaVuodet().get(1)); 
    fail("Huollot: 350 Did not throw IndexOutOfBoundsException");
    } catch(IndexOutOfBoundsException _e_){ _e_.getMessage(); }
    Huolto huolto2 = new Huolto(); 
    huolto2.parse(" 3  |  3  | 1.1.2021|200  | Jarru  | 100 | palat"); 
    huollot.lisaa(huolto2); 
    assertEquals("From: Huollot line: 354", "2021", huollot.annaVuodet().get(1)); 
    Huolto huolto3 = new Huolto(); 
    huolto3.parse(" 4  |  4  | 1.1.2019|200  | Jarru  | 100 | palat"); 
    huollot.lisaa(huolto3); 
    assertEquals("From: Huollot line: 358", "2019", huollot.annaVuodet().get(0)); 
    assertEquals("From: Huollot line: 359", "2020", huollot.annaVuodet().get(1)); 
    assertEquals("From: Huollot line: 360", "2021", huollot.annaVuodet().get(2)); 
  } // Generated by ComTest END
}